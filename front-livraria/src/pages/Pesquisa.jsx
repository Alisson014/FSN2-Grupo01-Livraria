...
function Pesquisa(){
    ...
    const livrosP = livros.filter(livro => livro.titulo.toLowerCase().includes(pesquisaLowerCase) || livro.autor.toLocaleLowerCase().includes(pesquisaLowerCase) || livro.categoria.toLocaleLowerCase().includes(pesquisaLowerCase) );
    ...
    return(
        <div>
            ...
            <div className={`Notfound ${livrosP.length === 0 ? 'Show' : ''}`}>
